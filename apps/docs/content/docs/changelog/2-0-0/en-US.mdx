...
2.0.0 follows 1.4.0. There is no 1.4.1 on the stores. The side panel from 1.4.0 stays. This release is the public site, the library, the install paths around it, and a pass on privacy and the extension.
