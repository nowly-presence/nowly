...
Discord activity text uses optional [presence language packs](/advanced-topics/presence-language-packs), which are separate from metadata and settings localization.
