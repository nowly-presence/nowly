...
import { IconCircleCheck } from "@/lib/tabler-icons";
          ...
          <div className="flex flex-wrap gap-1.5">
            {urls.map((url) => (
              <button
                ...
                className="inline-flex max-w-full truncate rounded-md bg-card-2 px-2 py-0.5 font-mono text-[11px] text-muted-foreground transition-colors hover:text-foreground"
              >
                {url}
              </button>
            ))}
