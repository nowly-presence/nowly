...
type Props = {
  ...
  control?: ReactNode
  // Id of the focusable element inside `control`, so the title can be
  // rendered as a <label htmlFor> bound to it.
  controlId?: string
  children?: ReactNode
}
  ...
  <SettingsBlock className="flex flex-col gap-2">
    {control ? (
      <div className="flex items-center justify-between gap-3">
        <HeadingText title={title} description={description} className="min-w-0" titleFor={controlId} />
