...
export const VinylAnimation = ({ size = 120 }: Props): React.JSX.Element => (
  <div className="flex items-center justify-center" aria-hidden="true">
    <style>{`@keyframes vinyl-spin { to { transform: rotate(360deg); } }`}</style>
    <svg viewBox="0 0 200 200" className="shrink-0" style={{ width: size, height: size, animation: "vinyl-spin 4s linear infinite" }} xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      <circle cx="100" cy="100" r="28" fill="var(--color-accent, #0891B2)" opacity="0.9" />
