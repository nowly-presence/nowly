  ...
  return (
    <nav className="shrink-0 px-3 pb-3">
      <div
        className={
          devReplayOnboarding
            ? "grid grid-cols-3 gap-1 overflow-hidden rounded-xl border border-border bg-card p-1"
            : "grid grid-cols-1 overflow-hidden rounded-xl border border-border bg-card"
        }
      >
        {devReplayOnboarding ? (
          <>
