...
// Mirrors packages/ui/src/button-variants.ts, minus the "dark"/"soft"
// variants (landing-page CTA styling, not used inside the side panel).
  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-[10px] border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-foreground/16",
        ghost: "bg-foreground/10 text-foreground hover:bg-foreground/16",
      ...
      size: {
        ...
        xs: "h-6 gap-1 rounded-[min(var(--radius-sm),8px)] px-2 text-xs has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
        ...
        icon: "size-9",
        "icon-xs": "size-6 rounded-[min(var(--radius-sm),8px)] [&_svg:not([class*='size-'])]:size-3",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
    },
